...
import com.tonthepduybao.api.model.*;
...
public class ProductServiceImpl implements ProductService {
            ...
            for (int rowIndex = firstRow + 1; rowIndex <= lastRow; rowIndex++) {
                ...
                if (StringUtils.hasLength(propertyName)) {
                    ...
                    for (String p : parts) {
                        ...
                        if (!StringUtils.hasLength(trimmed)) continue;
                        try {
    ...
    // Private function to get cell value using DataFormatter
    ...
    // Keep existing map-based property saving for API/UI flows
